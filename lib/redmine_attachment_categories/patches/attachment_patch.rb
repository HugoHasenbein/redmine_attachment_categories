...
unless Attachment.included_modules.include?(AttachmentCategories::Patches::AttachmentPatch)
    Attachment.send(:include, AttachmentCategories::Patches::AttachmentPatch)
end
